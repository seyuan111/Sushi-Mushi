...
const Hero = () => {
  return (
    <div className="w-full h-screen top-[90px] bg-zinc-900/70">
        ...
        <div className="w-full h-[90%] text-center flex flex-col items-center justify-center px-6 text-white">
            ...
            <p className="text-white px-80 font-Teko text-2xl"> Nestled in the heart of the city that never sleeps, New York City Sushi isn't just a restaurant; it's a testament to the innovative spirit and gastronomic passion that define our bustling metropolis. Our story began with a vision to reimagine sushi – not merely as a dish,
             but as an experience that captures the vibrancy of the city itself.</p> 
             <p className="text-white px-80 font-Teko pt-10 text-2xl">The fusion of diverse cultures, the boldness of urban creativity, and the precision of culinary craftsmanship converge within our walls. From the moment you step in, you're not just dining; you're becoming part of a legacy where each roll is a canvas, and every bite is an exploration of flavors as dynamic as the city that inspired them. 
