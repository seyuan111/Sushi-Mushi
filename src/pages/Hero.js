  ...
  return (
    <div className="w-full h-screen top-[90px] bg-zinc-900/70">
        ...
        <div className="w-full h-[90%] text-center flex flex-col items-center justify-center px-4 text-white">
            <h1 className="font-bold text-2xl underline">Welcome to Mushi Sushi</h1>
            <h1 className="text-[25px] mt-12 text-white">Where you can choose your favorite sushi and sashimi</h1>
            <p className="text-[20px] my-5 font-bold">Get started with ordering your sushi/sashimi or your favorite Japanese food.</p>
