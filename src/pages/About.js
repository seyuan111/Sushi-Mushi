  ...
  return (
    <div>
        ...
        <div className="w-full h-[90%] text-center flex flex-col items-center justify-center px-4 text-white">
            ...
            <h1 className="text-[25px] mt-12 text-white">Order your favorite Sushi, Sashimi, and all the other Japanese Foods you desire</h1>
            <p className="text-[20px] my-5 font-bold">Sushi Muchi has been in Business for several years</p>
