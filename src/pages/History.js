  ...
  return (
    <div className="w-full h-screen top-[90px] bg-zinc-900/70">
        ...
        <div className="w-full h-[90%] text-center flex flex-col items-center justify-center px-4 text-white">
            ...
            <h1 className="text-[25px] mt-12 text-white">We WILL A STORY HERE </h1>
            <p className="text-[20px] my-5 font-bold">TEAM WORK IS IMPORTANT.</p>
            <p className="mb-5 font-bold">WE MUST REMEMBER TO PUSH OUR CODE B4 SLEEP</p>
